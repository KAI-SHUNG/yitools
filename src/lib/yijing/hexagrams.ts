...
export const HEXAGRAM_DATA: HexagramEntry[] = [
  ...
  { wenNumber: 11, name: '泰', fullName: '地天泰', upper: 'kun',  lower: 'qian', guaCi: '泰：小往大来，吉亨。' },
  { wenNumber: 12, name: '否', fullName: '天地否', upper: 'qian', lower: 'kun',  guaCi: '否：否之匪人，不利君子贞，大往小来。' },
  ...
  { wenNumber: 32, name: '恒', fullName: '雷风恒', upper: 'zhen', lower: 'xun',  guaCi: '恒：亨，无咎，利贞，利有攸往。' },
  ...
  { wenNumber: 41, name: '损', fullName: '山泽损', upper: 'gen',  lower: 'dui',  guaCi: '损：有孚，元吉，无咎，可贞，利有攸往。' },
  ...
  { wenNumber: 51, name: '震', fullName: '震为雷', upper: 'zhen', lower: 'zhen', guaCi: '震：亨。震来虩虩，笑言哑哑。震惊百里，不丧匕鬯。' },
  { wenNumber: 52, name: '艮', fullName: '艮为山', upper: 'gen',  lower: 'gen',  guaCi: '艮：艮其背，不获其身，行其庭，不见其人，无咎。' },
  ...
  { wenNumber: 57, name: '巽', fullName: '巽为风', upper: 'xun',  lower: 'xun',  guaCi: '巽：小亨，利有攸往，利见大人。' },
  { wenNumber: 58, name: '兑', fullName: '兑为泽', upper: 'dui',  lower: 'dui',  guaCi: '兑：亨，利贞。' },
  ...
  { wenNumber: 63, name: '既济', fullName: '水火既济', upper: 'kan',  lower: 'li',   guaCi: '既济：亨小，利贞。初吉终乱。' },
  { wenNumber: 64, name: '未济', fullName: '火水未济', upper: 'li',   lower: 'kan',  guaCi: '未济：亨。小狐汔济，濡其尾，无攸利。' },
]

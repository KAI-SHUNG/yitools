...
export const HEXAGRAM_DATA: HexagramEntry[] = [
  { wenNumber: 1,  name: '乾', fullName: '乾为天', upper: 'qian', lower: 'qian', guaCi: '乾：元亨利贞。' },
  { wenNumber: 2,  name: '坤', fullName: '坤为地', upper: 'kun',  lower: 'kun',  guaCi: '坤：元亨，利牝马之贞。' },
  ...
  { wenNumber: 11, name: '泰', fullName: '地天泰', upper: 'kun',  lower: 'qian', guaCi: '泰：小往大来，吉亨。', liuChong: true },
  { wenNumber: 12, name: '否', fullName: '天地否', upper: 'qian', lower: 'kun',  guaCi: '否：否之匪人，不利君子贞，大往小来。', liuChong: true },
  ...
  { wenNumber: 16, name: '豫', fullName: '雷地豫', upper: 'zhen', lower: 'kun',  guaCi: '豫：利建侯行师。', liuHe: true },
  ...
  { wenNumber: 21, name: '噬嗑', fullName: '火雷噬嗑', upper: 'li',   lower: 'zhen', guaCi: '噬嗑：亨，利用狱。', liuChong: true },
  { wenNumber: 22, name: '贲', fullName: '山火贲', upper: 'gen',  lower: 'li',   guaCi: '贲：亨，小利有攸往。', liuChong: true },
  ...
  { wenNumber: 25, name: '无妄', fullName: '天雷无妄', upper: 'qian', lower: 'zhen', guaCi: '无妄：元亨利贞。其匪正有眚，不利有攸往。' },
  { wenNumber: 26, name: '大畜', fullName: '山天大畜', upper: 'gen',  lower: 'qian', guaCi: '大畜：利贞，不家食吉，利涉大川。', liuHe: true },
  ...
  { wenNumber: 29, name: '坎', fullName: '坎为水', upper: 'kan',  lower: 'kan',  guaCi: '坎：习坎，有孚，维心亨，行有尚。' },
  { wenNumber: 30, name: '离', fullName: '离为火', upper: 'li',   lower: 'li',   guaCi: '离：利贞，亨。畜牝牛，吉。' },
  { wenNumber: 31, name: '咸', fullName: '泽山咸', upper: 'dui',  lower: 'gen',  guaCi: '咸：亨，利贞，取女吉。' },
  { wenNumber: 32, name: '恒', fullName: '雷风恒', upper: 'zhen', lower: 'xun',  guaCi: '恒：亨，无咎，利贞，利有攸往。', liuChong: true },
  { wenNumber: 33, name: '遁', fullName: '天山遁', upper: 'qian', lower: 'gen',  guaCi: '遁：亨，小利贞。' },
  { wenNumber: 34, name: '大壮', fullName: '雷天大壮', upper: 'zhen', lower: 'qian', guaCi: '大壮：利贞。' },
  ...
  { wenNumber: 39, name: '蹇', fullName: '水山蹇', upper: 'kan',  lower: 'gen',  guaCi: '蹇：利西南，不利东北。利见大人，贞吉。', liuChong: true },
  { wenNumber: 40, name: '解', fullName: '雷水解', upper: 'zhen', lower: 'kan',  guaCi: '解：利西南，无所往，其来复吉。有攸往，夙吉。', liuHe: true },
  { wenNumber: 41, name: '损', fullName: '山泽损', upper: 'gen',  lower: 'dui',  guaCi: '损：有孚，元吉，无咎，可贞，利有攸往。', liuHe: true },
  { wenNumber: 42, name: '益', fullName: '风雷益', upper: 'xun',  lower: 'zhen', guaCi: '益：利有攸往，利涉大川。' },
  ...
  { wenNumber: 45, name: '萃', fullName: '泽地萃', upper: 'dui',  lower: 'kun',  guaCi: '萃：亨。王假有庙，利见大人，亨，利贞。用大牲吉，利有攸往。', liuHe: true },
  ...
  { wenNumber: 48, name: '井', fullName: '水风井', upper: 'kan',  lower: 'xun',  guaCi: '井：改邑不改井，无丧无得，往来井井。', liuHe: true },
  { wenNumber: 49, name: '革', fullName: '泽火革', upper: 'dui',  lower: 'li',   guaCi: '革：已日乃孚，元亨利贞，悔亡。' },
  { wenNumber: 50, name: '鼎', fullName: '火风鼎', upper: 'li',   lower: 'xun',  guaCi: '鼎：元吉，亨。', liuHe: true },
  ...
  { wenNumber: 53, name: '渐', fullName: '风山渐', upper: 'xun',  lower: 'gen',  guaCi: '渐：女归吉，利贞。', liuHe: true },
  { wenNumber: 54, name: '归妹', fullName: '雷泽归妹', upper: 'zhen', lower: 'dui',  guaCi: '归妹：征凶，无攸利。', liuHe: true },
  { wenNumber: 55, name: '丰', fullName: '雷火丰', upper: 'zhen', lower: 'li',   guaCi: '丰：亨，王假之，勿忧，宜日中。' },
  { wenNumber: 56, name: '旅', fullName: '火山旅', upper: 'li',   lower: 'gen',  guaCi: '旅：小亨，旅贞吉。', liuHe: true },
  ...
  { wenNumber: 63, name: '既济', fullName: '水火既济', upper: 'kan',  lower: 'li',   guaCi: '既济：亨小，利贞。初吉终乱。', liuChong: true },
  { wenNumber: 64, name: '未济', fullName: '火水未济', upper: 'li',   lower: 'kan',  guaCi: '未济：亨。小狐汔济，濡其尾，无攸利。', liuChong: true },
]
